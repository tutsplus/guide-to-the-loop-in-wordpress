...
/****************************************************************************
Modify loop on projects archive page
****************************************************************************/
function tutsplus_modify_loop_projects( $query ) {
	
	if ( $query->is_post_type_archive( 'tutsplus_project') && $query->is_main_query() ) {
		$query->set( 'orderby', 'title' );
		$query->set( 'order', 'ASC' );
	}
	
}
add_action( 'pre_get_posts', 'tutsplus_modify_loop_projects' );